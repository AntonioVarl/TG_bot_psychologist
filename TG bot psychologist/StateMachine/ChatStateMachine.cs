...
public class ChatStateMachine
{
    ...
    public ChatStateMachine(ITelegramBotClient botClient, AppSettings.AppSettings appSettings, IChatGptService chatGptService,
        UsersDataProvider usersDataProvider)
    {
        ...
        _states[typeof(UserDataSubmissionState)] = () =>
            new UserDataSubmissionState(this, botClient, usersDataProvider, appSettings.ManagerChannelId);
